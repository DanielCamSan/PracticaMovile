...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainViewModel = MainViewModel(GetPopularBook(MoviesRepository(MovieDataSource( RetrofitBuilder() ), "fa3e844ce31744388e07fa47c7c5d8c3")))
...
class MoviesRepository(movieData: MovieDataSource, key: String)
{

}
class MovieDataSource(retro: RetrofitBuilder)
{
